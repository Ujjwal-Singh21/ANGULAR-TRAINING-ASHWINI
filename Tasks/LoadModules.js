...
var Emoloyee_1 = require("./Emoloyee");

var emp1 = new Emoloyee_1.Employee(101, 'Steve', 5000);
var emp2 = new Emoloyee_1.Employee(102, 'Clarke', 3000);
var emp3 = new Emoloyee_1.Employee(103, 'Diana', 2500);
var emp4 = new Emoloyee_1.Employee(104, 'Tony', 9000);
var emp5 = new Emoloyee_1.Employee(105, 'Vishwas', 15000);
